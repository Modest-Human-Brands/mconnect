...
- Update email templates and API error messages for improved clarity and context ([f89a16d](https://github.com/Modest-Human-Brands/mconnect/commit/f89a16d))
...
- Enhance email templates with tracking capabilities and dynamic links ([0ecdbb3](https://github.com/Modest-Human-Brands/mconnect/commit/0ecdbb3))
...
- **quotation-template:** Update deliverables structure and improve readability ([22733c7](https://github.com/Modest-Human-Brands/mconnect/commit/22733c7))
...
- Remove unnecessary apk add commands and update exec command in iii-config.yaml ([977f23f](https://github.com/shba007/mconnect/commit/977f23f))
...
[compare changes](https://github.com/shba007/mconnect/compare/v0.2.0...v0.2.1)

### 🩹 Fixes

- Update build command in Dockerfile and format apk add commands ([c174979](https://github.com/shba007/mconnect/commit/c174979))
