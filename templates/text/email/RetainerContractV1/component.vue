        ...
        <Container class="mx-auto w-full max-w-[600px] my-10">
          <Section class="bg-white p-10 border-t-4" :style="{ borderColor: organizationColorPrimary }">
            <Section class="mb-8 text-center">
              ...
              <Text class="m-0 text-2xl font-black text-gray-900 leading-tight"> Retainer Agreement </Text>
            </Section>
            ...
            <Section class="bg-gray-50 rounded border border-gray-100 p-5 mb-8">
              <Text class="m-0 text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 border-b border-gray-200 pb-2"> Engagement Summary </Text>

              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tbody>
                  <tr>
                    <td align="left" valign="top" class="pb-3" width="35%">
                      <Text class="m-0 text-sm font-semi-bold text-gray-700">Engagement:</Text>
                    </td>
                    <td align="left" valign="top" class="pb-3">
                      <Text class="m-0 text-sm text-gray-900">{{ engagementTitle }} ({{ serviceCategory }})</Text>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" class="pb-3">
                      <Text class="m-0 text-sm font-semi-bold text-gray-700">Term:</Text>
                    </td>
                    <td align="left" valign="top" class="pb-3">
                      <Text class="m-0 text-sm text-gray-900"> {{ formatDate(startDate) }} &ndash; {{ formatDate(endDate) }} ({{ engagementMonths }} month{{ engagementMonths > 1 ? 's' : '' }}) </Text>
                    </td>
                  </tr>
                  <tr>
            ...
            <Section class="text-center mb-8">
              ...
              <Text class="m-0 text-xs text-gray-400 mt-4 leading-relaxed px-4">
                By clicking the button above, you will be redirected to our secure portal to review the full legal terms regarding scope, compensation, term, and renewal.
              </Text>
            </Section>
            ...
            <Section class="text-center">
              <Text class="m-0 text-xs text-gray-500 leading-relaxed mb-2"> If you have any questions regarding the terms of this agreement, please reply directly to this email. </Text>
