...
| **9**  | `POST /api/connect/call/phone/send`               | 3. Voice Control Layer    | **Advanced**: Spins up a centralized LiveKit Media Room, creates an internal participant session, and fires an asynchronous SIP Outbound Trunk invite to bridge the external customer leg seamlessly.                        | ✅ **Done**    |
